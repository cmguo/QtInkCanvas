...
private:
    ...
    public:
        ...
        /// <returns></returns>
        int CompareTo(LassoCrossing const & crossing)
        {
...
protected:
    ...
    /// </summary>
    static double FindIntersection(QPointF const & hitBegin, QPointF const & hitEnd, QPointF const & orgBegin, QPointF const & orgEnd)
    {
