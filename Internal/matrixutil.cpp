...
void MatrixUtil::TransformRect(Rect & rect, Matrix const & matrix)
{
    if (rect.IsEmpty())
    {
        return;
...
/// </summary>
void MatrixUtil::MultiplyMatrix(Matrix & matrix1, Matrix const & matrix2)
{
    ...
    if (type2 == MatrixTypes::TRANSFORM_IS_TRANSLATION)
    {
        ...
        {
            matrix1._type = matrix1._type | MatrixTypes::TRANSFORM_IS_TRANSLATION;
        }
    ...
    double offsetY)
{
    ...
    else
    {
        ...
        {
            matrix._type = matrix._type | MatrixTypes::TRANSFORM_IS_TRANSLATION;
        }
    }
}
