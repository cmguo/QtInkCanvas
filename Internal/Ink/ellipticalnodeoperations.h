...
public:
    ...
    /// </summary>
    virtual bool IsNodeShapeEllipse() override { return true; }
    ...
    virtual Quad GetConnectingQuad(StrokeNodeData const & beginNode, StrokeNodeData const & endNode) override;
