...
Guid KnownIdCache::OriginalISFIdTable[] = {
    ...
    {0x6e0e07bfu, 0xafe7, 0x4cf7, 0x87, 0xd1, 0xaf, 0x64, 0x46, 0x20, 0x84, 0x18},
    {0x436510c5u, 0xfed3, 0x45d1, 0x8b, 0x76, 0x71, 0xd3, 0xea, 0x7a, 0x82, 0x9d},
    {0x78a81b56, 0x0935, 0x4493, 0xba, 0xae, 0x00, 0x54, 0x1a, 0x8a, 0x16, 0xc4},
    {0x7307502du, 0xf9f4, 0x4e18, 0xb3, 0xf2, 0x2c, 0xe1, 0xb1, 0xa3, 0x61, 0x0c},
    ...
    {0x029123b4u, 0x8828, 0x410b, 0xb2, 0x50, 0xa0, 0x53, 0x65, 0x95, 0xe5, 0xdc},
    ...
    {0x7f7e57b7u, 0xbe37, 0x4be1, 0xa3, 0x56, 0x7a, 0x84, 0x16, 0x0e, 0x18, 0x93},
    ...
    {0x33c1df83u, 0xecdb, 0x44f0, 0xb9, 0x23, 0xdb, 0xd1, 0xa5, 0xb2, 0x13, 0x6e},
    {0x5329cda5u, 0xfa5b, 0x4ed2, 0xbb, 0x32, 0x83, 0x46, 0x01, 0x72, 0x44, 0x28},
    {0x002df9afu, 0xdd8c, 0x4949, 0xba, 0x46, 0xd6, 0x5e, 0x10, 0x7d, 0x1a, 0x8a},
    ...
    {0x5c0b730au, 0xf394, 0x4961, 0xa9, 0x33, 0x37, 0xc4, 0x34, 0xf4, 0xb7, 0xeb},
    {0x2812210fu, 0x871e, 0x4d91, 0x86, 0x07, 0x49, 0x32, 0x7d, 0xdf, 0x0a, 0x9f},
...
unsigned int KnownIdCache::OriginalISFIdTableLength = sizeof(OriginalISFIdTable) / sizeof(OriginalISFIdTable[0]);

// Size of data used by identified by specified QUuid/Id
unsigned int KnownIdCache::OriginalISFIdPersistenceSize[] = {
    sizeof(int),           // X                         0
    sizeof(int),           // Y                         1
    sizeof(int),           // Z                         2
...
Guid KnownIdCache::TabletInternalIdTable[] = {
        // Highlighter
    {0x9b6267b8, 0x3968, 0x4048, 0xab, 0x74, 0xf4, 0x90, 0x40, 0x6a, 0x2d, 0xfa},
        // Ink properties
    {0x7fc30e91u, 0xd68d, 0x4f07, 0x8b, 0x62, 0x6, 0xf6, 0xd2, 0x73, 0x1b, 0xed},
        // Ink Style Bold
    ...
    {0x5253b51, 0x49c6, 0x4a04, 0x89, 0x93, 0x64, 0xdd, 0x9a, 0xbd, 0x84, 0x2a},
        // Stroke Timestamp
    {0x4ea66c4u, 0xf33a, 0x461b, 0xb8, 0xfe, 0x68, 0x7, 0xd, 0x9c, 0x75, 0x75},
        // Stroke Time Id
...
unsigned int KnownIdCache::TabletInternalIdTableLength = sizeof(TabletInternalIdTable) / sizeof(TabletInternalIdTable[0]);

Guid KnownIdCache::ExtendedISFIdTable[] = {
    // Highlighter
    {0x9b6267b8, 0x3968, 0x4048, 0xab, 0x74, 0xf4, 0x90, 0x40, 0x6a, 0x2d, 0xfa},
    // Ink properties
    {0x7fc30e91u, 0xd68d, 0x4f07, 0x8b, 0x62, 0x6, 0xf6, 0xd2, 0x73, 0x1b, 0xed},
