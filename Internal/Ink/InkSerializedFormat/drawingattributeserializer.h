...
public:
    static constexpr uint        RasterOperationMaskPen = 9;
    static constexpr uint        RasterOperationDefaultV1 = 13;
    ...
    /*
    static uint DecodeAsISF(QIODevice * stream, QList<QUuid> & guidList, uint maximumStreamSize, DrawingAttributes & da)
    {
        ...
        uint rasterOperation = RasterOperationDefaultV1;
    ...
    /// </Summary>
#endif
    static uint EncodeAsISF(DrawingAttributes da, Stream stream, GuidList guidList, byte compressionAlgorithm, bool fTag)
    {
#if DEBUG
    ...
    static void PersistDrawingFlags(DrawingAttributes da, Stream stream, GuidList guidList, ref uint cbData, ref BinaryWriter bw)
    {
        //
    ...
    static void PersistColorAndTransparency(DrawingAttributes da, Stream stream, GuidList guidList, ref uint cbData, ref BinaryWriter bw)
    {
    ...
    static void PersistRasterOperation(DrawingAttributes da, Stream stream, GuidList guidList, ref uint cbData, ref BinaryWriter bw)
    {
    ...
    /// </Summary>
#endif
    static void PersistExtendedProperties(DrawingAttributes da, Stream stream, GuidList guidList, ref uint cbData, ref BinaryWriter bw, byte compressionAlgorithm, bool fTag)
    {
    ...
    /// </Summary>
#endif
    static void PersistStylusTip(DrawingAttributes da, Stream stream, GuidList guidList, ref uint cbData, ref BinaryWriter bw)
    {
        //
    ...
    static void PersistWidthHeight(DrawingAttributes da, Stream stream, GuidList guidList, ref uint cbData, ref BinaryWriter bw)
    {
    ...
    static class PersistenceTypes
    {
        public static constexpr Type StylusTip = typeof(Int32);
        public static constexpr Type IsHollow = typeof(bool);
        public static constexpr Type StylusTipTransform = typeof(string);
    }
    */
};
