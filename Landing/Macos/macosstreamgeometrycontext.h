...
class MacosStreamGeometryContext : public StreamGeometryContext
{
public:
    MacosStreamGeometryContext(StreamGeometry * geometry);
    virtual ~MacosStreamGeometryContext() override;
