#ifndef WINDOWS_CONTROLS_INKCANVASSTROKESREPLACEDEVENTARGS_H
#define WINDOWS_CONTROLS_INKCANVASSTROKESREPLACEDEVENTARGS_H
...
#endif // WINDOWS_CONTROLS_INKCANVASSTROKESREPLACEDEVENTARGS_H
