...
public:
    ...
    /// </summary>
    /// <returns></returns>
    int GetOutputArrayLengthPerPoint();
    ...
    /// </summary>
    int GetButtonBitPosition(StylusPointProperty buttonProperty);
